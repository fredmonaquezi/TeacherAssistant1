...
enum StudentReportExporter {
    ...
    static func export(
        ...
        try? renderer.writePDF(to: url) { context in
            ...
            // Date
            ("Date: \(Date().appDateString(systemStyle: .medium))").draw(
...
enum StudentReportExporter {
    ...
    static func export(
        ...
        drawText(
            String(format: "Date: %@".localized, Date().appDateString(systemStyle: .medium)),
            fontSize: 12
        )
        ...
        let footerText = "Generated by Teacher Assistant • Page 1 • \(Date().appDateString(systemStyle: .medium))"
