...
func makeSampleVersionedBackup(schemaVersion: Int = 6) -> VersionedBackupFileHarness {
    ...
    return VersionedBackupFileHarness(
        ...
        appSettings: BackupAppSettings(
            ...
            customRotationData: "[]",
            randomPickerFairHistoryData: "",
            randomPickerRoleCycleData: "",
            ...
            motionProfile: AppMotionProfile.full.rawValue,
            attentionRemindersEnabled: true,
            attentionNotificationsEnabled: false,
            attentionNotificationHour: 7,
            attentionNotificationMinute: 30,
